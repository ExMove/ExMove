...
## Here, we work on data formatted in the main processing workflow
## The data frame we read in is df_diagnostic produced in step 4
...
filepath <- "TestDataOutputs/WorkingDataFrames/RFB_diagnostic.csv"
...
filepath_dfout <- here("TestDataOutputs","WorkingDataFrames") #specify where df's will be saved
