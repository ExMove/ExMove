...
Miscellaneous sf questions that could either be addressed here, or just pointed to the [sf misc page](https://cran.r-project.org/web/packages/sf/vignettes/sf6.html#what_is_this_epsg_code_all_about)
