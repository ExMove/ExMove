...
#| warning: false
library(flextable)
metadata_table <- read_csv(here("Data", "RFB_IMM_Metadata.csv")) %>%
...
Argos fix quality can be used to filter the data set to remove locations with too much uncertainty. If you know the error classes that you want to retain in this dataset, you can run this filter below. </br>
